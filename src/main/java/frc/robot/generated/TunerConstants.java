...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(45).withKI(0).withKD(0.2)
        .withKS(0).withKV(0.48).withKA(0);
    ...
    private static final double kSlipCurrentA = 255.0;

    // Theoretical free speed (m/s) at 12v applied output;
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 4.572;
    ...
    private static final double kFrontLeftEncoderOffset = -0.268310546875;
    ...
    private static final double kFrontRightEncoderOffset = 0.039794921875;
    ...
    private static final double kBackLeftEncoderOffset = 0.437255859375;
    ...
    private static final double kBackRightEncoderOffset = 0.252685546875;
